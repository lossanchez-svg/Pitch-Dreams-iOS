...
struct CreateActivityBody: Codable { let activityType: String; let durationMinutes: Int; let gameIQImpact: String; var intensityRPE: Int?; var opponentName: String?; var notes: String?; var facilityId: String?; var coachId: String?; var programId: String?; var focusTagIds: [String]?; var highlightIds: [String]?; var nextFocusIds: [String]? }
struct CreateCheckInBody: Codable { let energy: Int; let soreness: String; let focus: Int; let mood: String; let timeAvail: Int; let painFlag: Bool }
struct QuickCheckInBody: Codable { let mood: String; var timeAvail: Int? }
